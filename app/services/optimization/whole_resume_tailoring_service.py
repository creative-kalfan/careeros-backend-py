...
class WholeResumeTailoringService:
    ...
    def _call_llm_tailoring(
        ...
        system_instruction = (
            ...
            "8. Refine experience bullet points and sub-engagement bullets using the Action → Context → Method → Impact (ACMI) framework:\n"
            "   - Action: Begin with a strong past-tense action verb (e.g. Engineered, Orchestrated, Analyzed, Streamlined, Automated, Architected).\n"
